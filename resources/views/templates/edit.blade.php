                            ...
                            <form method="POST" action="{{ route('templates.update', $template) }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" 
                                              ...
                                              name="content" 
                                              rows="20" 
                                              placeholder="Enter your template content with variables like [PRODUCT_NAME], [COUNTRY], etc."
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="text-center">
                                                        <h5 class="text-primary">{{ $template->aiRequests()->count() }}</h5>
                                                        <small class="text-muted">AI Requests</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="text-center">
                                                        <h5 class="text-success">{{ $template->created_at->format('M d, Y') }}</h5>
                                                        <small class="text-muted">Created</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="text-center">
                                                        <h5 class="text-info">{{ $template->updated_at->format('M d, Y') }}</h5>
